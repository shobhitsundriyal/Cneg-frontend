	...
	return (
		...
		>
			<div className='rounded-lg bg-[#f7eeee] pl-8 pt-8 pr-20 tracking-wide leading-[160%]'>
				...
				{/**Expalin */}
				<div>
					With C-negative, you can buy carbon credits and burn them on
					the blockchain - leaving the world with less permitted
					carbon emissions.
				</div>
				<div className='mt-5'>
					{' '}
				...
				<div className=' text-xs mt-2'>
					*Base Carbon Tonnes (BCT) is a reference token representing
					...
					(VCU) registry from 2008 or later, bridged by the Toucan
					Protocol.
				</div>
